...
| Version | Link | Branch |
|---------|------|--------|
| **V1** — Vertical Scroll | [sabum.github.io/YEOBAEK](https://sabum.github.io/YEOBAEK/) | `main` |
| **V2** — Horizontal Scroll | [sabum.github.io/YEOBAEK/v2](https://sabum.github.io/YEOBAEK/v2/) | `v2` |
...
│   └── main.js         # 스크롤 & 인터랙션 로직
└── img/
    ├── hero_pingpong.mp4       # Hero 배경 (ping-pong)
    ├── craft_pingpong.mp4      # Craft 배경 (ping-pong)
    └── moon_jar_philosophy.png # Philosophy 이미지
```
